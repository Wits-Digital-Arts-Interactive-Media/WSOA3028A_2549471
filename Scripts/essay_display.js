...
function expand_pdf(pdf_path, article_location, array_check_location) {
    //<iframe style="width: 1300px; height: 2000px;" src=""../essay/my written essays/Title_ Ethics, UI, UX, and Interaction_ A Comprehensive Analysis of Takealot's Website.pdf" target="_blank">Essay 1: UX & UI Analysis
